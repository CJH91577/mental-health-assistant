        ...
        <div class="content">
            <div class="text">
                ...
                <div class="hero-actions">
                    ...
                    <el-button size="large" style="border-color: #fff" color="transparent" @click="goDiary">记录心情，释放情感</el-button>
                </div>
            </div>
            <div class="robot">
...
const goConsultation = () => router.push('/consultation')
const goDiary = () => router.push('/emotion-diary')
