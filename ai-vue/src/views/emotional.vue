    ...
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="用户" width="80">
                <template #default="scope">
                    <el-avatar>{{ scope.row.nickname || scope.row.username || '-' }}</el-avatar>
                </template>
            </el-table-column>
        ...
        <el-dialog v-model="detailDialogVisible" title="情绪日志详情" width="800px" :close-on-click-modal="false">
            <div class="detail-content" v-if="currentDetail">
                ...
                <div class="detail-section">
                    <h4>AI情绪分析结果</h4>
                    <el-empty v-if="!hasAiAnalysis" description="暂无 AI 情绪分析（配置 AI Key 后自动生成）" :image-size="60" />
                    <div class="ai-analysis-result" v-else>
                        <el-descriptions :column="2" border>
                            <el-descriptions-item label="主要情绪">
...
const viewSessionDetail = (row) => {
    ...
    if (row.aiEmotionAnalysis) {
        try {
            ...
            hasAiAnalysis.value = !!aiData.value
        } catch (e) {
            aiData.value = null
